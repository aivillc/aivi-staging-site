  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden bg-black">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-gradient-to-r from-orange-600/10 via-transparent to-purple-500/10 rounded-full blur-3xl animate-spin-slow" />
        ...
        <div className="absolute inset-0 overflow-hidden opacity-30">
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-orange-500 to-transparent top-1/4 animate-scan-horizontal" />
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-purple-500 to-transparent top-1/2 animate-scan-horizontal-reverse" />
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-orange-500 to-transparent top-3/4 animate-scan-horizontal-slow" />
        </div>
      ...
      <section id="features" className="relative py-24 px-6 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute inset-0 bg-[linear-gradient(rgba(255,107,53,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,107,53,0.1)_1px,transparent_1px)] bg-[size:50px_50px]" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-orange-200 rounded-2xl p-8 hover:border-orange-400 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Automated Shipment Updates</h3>
            ...
            <div className="bg-white border border-purple-200 rounded-2xl p-8 hover:border-purple-400 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Delivery Time Windows</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white border border-orange-200 rounded-2xl p-8 hover:border-orange-400 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Exception Management</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white border border-purple-200 rounded-2xl p-8 hover:border-purple-400 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Proof of Delivery</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white border border-orange-200 rounded-2xl p-8 hover:border-orange-400 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Two-Way Communication</h3>
              <p className="text-gray-600">
