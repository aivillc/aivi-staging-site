      ...
      <div className="w-full max-w-[calc(100%-24px)] sm:max-w-[calc(100%-48px)] mx-auto text-center bg-white rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 md:p-12 lg:p-16 animate-[fadeInUp_0.6s_ease-out]">
        ...
        <h1 className="text-[32px] sm:text-[42px] md:text-[56px] lg:text-[68px] leading-[1.1] font-normal text-[#000000] tracking-[-0.015em] mb-4 sm:mb-6 animate-[fadeInUp_0.8s_ease-out]">
          ...
          <span className="relative inline-block">
            smarter
            <span className="absolute bottom-0 left-0 w-full h-1 sm:h-2 bg-[#E5FF00]/30 -z-10" />
          </span>
          ,
          <br />
        ...
        {/* Email Signup Form */}
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-4 animate-[fadeInUp_1.2s_ease-out]">
          ...
          <button
            type="submit"
            className="group relative w-full sm:w-auto h-12 px-7 bg-[#E5FF00] text-[#000000] text-[15px] font-semibold rounded-md hover:bg-[#D4EE00] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 whitespace-nowrap overflow-hidden"
          >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-stretch mb-6">
          <button className="group w-full sm:w-[224px] h-12 bg-white border-2 border-[#DDDDDD] rounded-md flex items-center justify-center gap-2.5 text-[15px] font-medium text-[#000000] hover:bg-[#F9F9F9] hover:border-[#999999] hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300">
        ...
        <div className="w-full mx-auto relative group">
          <div className="w-full rounded-xl sm:rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.12)] group-hover:shadow-[0_16px_48px_rgba(0,0,0,0.18)] transition-shadow duration-500">
            <div className="relative aspect-video bg-white">
              ...
              <div className="absolute bottom-3 left-3 sm:bottom-6 sm:left-6 bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-[0_4px_24px_rgba(0,0,0,0.15)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.2)] max-w-[calc(100%-24px)] sm:max-w-[480px] transition-all duration-300 animate-[fadeInLeft_1.5s_ease-out]">
                <p className="text-[12px] sm:text-[13px] leading-[1.5] text-[#333333] mb-3 sm:mb-4">
                  We use cookies to enhance your browsing experience and analyze our traffic. By clicking
                  &quot;Accept all&quot;, you consent to our use of cookies.
                </p>
                <div className="flex flex-wrap gap-2 mb-2 sm:mb-3">
                  <button className="flex-1 min-w-[80px] px-3 sm:px-4 py-2 bg-transparent border border-[#DDDDDD] text-[12px] sm:text-[13px] rounded-md hover:bg-[#F9F9F9] hover:border-[#999999] hover:scale-105 transition-all duration-200">
                    More choices
                  </button>
                  <button className="flex-1 min-w-[80px] px-3 sm:px-4 py-2 bg-transparent border border-[#DDDDDD] text-[12px] sm:text-[13px] rounded-md hover:bg-[#F9F9F9] hover:border-[#999999] hover:scale-105 transition-all duration-200">
                    Reject all
                  </button>
                  <button className="flex-1 min-w-[80px] px-3 sm:px-4 py-2 bg-[#000000] text-white text-[12px] sm:text-[13px] rounded-md hover:bg-[#222222] hover:scale-105 transition-all duration-200">
                    Accept all
                  </button>
                </div>
                <a href="#" className="text-[12px] sm:text-[13px] text-[#666666] underline hover:text-[#000000] flex items-center gap-1 w-fit hover:translate-x-1 transition-transform duration-200">
