...
export default function AIVICTASection() {
  ...
  return (
    <section
      className="w-full bg-[#E8E5E0] px-3 sm:px-6 py-6"
      ...
      <div className="w-full max-w-[calc(100%-24px)] sm:max-w-[calc(100%-48px)] mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 md:p-12 lg:p-16">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2
              id="cta-heading"
              className="text-[32px] sm:text-[42px] md:text-[52px] lg:text-[58px] leading-[1.1] font-normal text-[#000000] tracking-[-0.015em]"
            >
              Stay Ahead of{' '}
              <span className="aivi-gradient-text">Call Screening</span>{' '}
              Changes
            </h2>

            <p className="text-[15px] sm:text-[17px] leading-[1.6] text-[#666666] max-w-[500px] mb-8 sm:mb-12">
              With iOS 26 adoption increasing, Apple&apos;s call screening prevents unknown numbers from reaching customers&mdash;even when a call is requested. Our AI agent recognizes, converses with, and reaches end customers dynamically, ensuring your message gets through.
            </p>
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4 mt-8 sm:mt-12">
              <div className="relative group">
                ...
                <input
                  ...
                  autoComplete="email"
                  className={`w-full h-12 bg-white border-2 rounded-md px-4 text-[15px] text-[#000000] placeholder:text-[#999999] focus:outline-none transition-all duration-300 focus-brand-ring ${
              ...
              <button
                type="submit"
                className="group relative w-full h-12 text-white text-[15px] font-semibold rounded-md hover:-translate-y-1 hover:shadow-xl transition-all duration-300 overflow-hidden bg-gradient-to-r from-[#f84608] to-[#321ca3] focus-brand-ring"
              >
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="group h-12 bg-white border-2 border-[#DDDDDD] rounded-md flex items-center justify-center gap-2 text-[15px] font-medium text-[#000000] hover:bg-[#F9F9F9] hover:border-[#999999] hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 focus-brand-ring"
