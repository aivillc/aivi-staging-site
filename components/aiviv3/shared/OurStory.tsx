    ...
    <section className="w-full py-12 sm:py-16 font-manrope">
      <div className="max-w-[900px] mx-auto text-center px-4">
        ...
        <div className="space-y-6 text-[17px] sm:text-[18px] md:text-[19px] leading-[1.7] text-[#666666] text-left">
          ...
          <p>
            Meanwhile, Olly was running a digital agency managing $100M in annual ad spend. His clients kept complaining
            about &quot;bad lead quality&quot;—but the leads were fine. The problem was simple: by the time they called back
            23 minutes later, competitors had already gotten there.
          </p>
