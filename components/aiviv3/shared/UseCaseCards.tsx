...
export default function UseCaseCards({ useCases, sectionTitle = 'The Solution' }: UseCaseCardsProps) {
  return (
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-soft">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => (
              <div
                key={index}
                className="bg-[#F5F5F5] rounded-xl p-6 flex gap-4"
              >
                {/* Icon */}
                <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-[#FF8C00]/20 to-[#8A2BE2]/20 flex items-center justify-center">
                  <div style={{ color: index % 2 === 0 ? '#FF8C00' : '#8A2BE2' }}>
